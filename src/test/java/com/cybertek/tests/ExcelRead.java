...
public class ExcelRead {
    ...
    public void excel_read_test() throws IOException {
        ...
        //Returns the count from top to buttom
        ...
        for (int rowNum = 0; rowNum < usedRows; rowNum++) {
            ...
            if (currentCell.toString().equals("Nureddin")){
        ...
        for (int rowNum = 0; rowNum < usedRows; rowNum++) {
            ...
            if (sheet.getRow(rowNum).getCell(1).toString().equals("Azizov")){
                System.out.println("Aybeniz's last name: " + sheet.getRow(rowNum).getCell(1) );
            }
        ...
        for (int rowNum = 0; rowNum < usedRows; rowNum++) {
            ...
            if (sheet.getRow(rowNum).getCell(1).toString().equals("Azizov")){
                System.out.println("Aybeniz's Job_ID is = " + sheet.getRow(rowNum).getCell(2) );
            }
